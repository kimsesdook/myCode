...
DML(MANIPULATION 데이터 조작어) : INSERT, UPDATE, DELECT
...
[DML]
데이터 조작어
테이블 값을 삽입(INSERT), 삭제(DELETE), 수정(UPDATE)하는 구문
*/
...
--INSERT INTO EMPLOYEE VALUES(900, '김수민','880914-1234567','SD122@naber.com',0112152121501,'Q7','T5',8000000,0.2,200,SYSDATE,NULL,'N');
...
INSERT INTO TMP_01(SELECT EMP_ID, EMP_NAME, DEPT_TITLE
                   FROM EMPLOYEE
...
UPDATE EMP_SALARY SET BONUS = 0.3 WHERE EMP_ID IN (SELECT EMP_ID
                                                     FROM EMP_SALARY
