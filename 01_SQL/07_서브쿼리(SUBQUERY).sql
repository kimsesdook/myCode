...
WHERE DEPT_CODE = (SELECT DEPT_CODE
                   ...
                   WHERE EMP_NAME = '노옹철');
--서브쿼리 예시2)
--전 직원의 평균급여보다 더 많은 급여를 받는 사원들의 사번, 이름,직급코도, 급여 조회
...
--다중행 다중열 서브쿼리 : 서브쿼리의 조회 결과값이 여러행 여러컬럼일때
...
--1)유재식 또는 윤은혜 사원과 같은 직급인 사원들의 사번, 사원명, 직급코드, 급여조회
SELECT EMP_ID, EMP_NAME, JOB_CODE, SALARY
FROM EMPLOYEE
...
--2) 대리직급임에도 과장직급의 최소 급여보다 더 많이 받는 사원들의 사번,  이름, 직급, 급여 조회
...
WHERE (JOB_CODE = 'J1' AND SALARY = 8000000)
    OR  (JOB_CODE = 'J2' AND SALARY = 8000000)
    OR  (JOB_CODE = 'J3' AND SALARY = 8000000)
    OR  (JOB_CODE = 'J4' AND SALARY = 8000000)
    OR  (JOB_CODE = 'J5' AND SALARY = 8000000)
    OR  (JOB_CODE = 'J6' AND SALARY = 8000000)
    OR  (JOB_CODE = 'J7' AND SALARY = 8000000);
