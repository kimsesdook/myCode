...
주로 기본키로 사용되는 회원번호, 사원번호....등에 활용됨
시퀀스르 사용하면 중복 없는 숫자값을 편리하게 관리할 수 있음.
...
예 CACHE 20->시퀀스를 미리 20개 만들어두고 필요할 때 꺼내씀
*/
...
JOB_CODE)
VALUES(
SEQ_EMPNO.NEXTVAL, '최지구','701011-1234567','J7'
);
...
JOB_CODE)
VALUES(
SEQ_EMPNO.NEXTVAL, '최지DUF','701011-1234567','J6'
);
