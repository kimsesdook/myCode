/*
[트리거]
특정 테이블에 대해 INSERT, UPDATE, DELETE와 같은 DML이벤트가 발생햇을 때
...
[트리거 생성 표현식]
CREATE [OR REFLACE] TRIGGER 트리거명
...
VALUES(31,'김지원','111111-2222222','J7');
--입출고에 대한 데이터 기록이 인설트 될때마다 해당 상품에 대한 재고수량을 매번 수정
--상품테이블(재고), 입출고기록테이블

--1.상풍에 대한 데이터를 보관할 상품 테이블(TB_PRODUCT)
...
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL, '갤럭시 S25', '삼성' , 1500000, DEFAULT);
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL, '아이폰', '애플' , 1000000, DEFAULT);
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL, '샤오미', '중궈런' , 990000, DEFAULT);

DROP TABLE TB_PRODETAIL;
--2.상품 입출고 상세 이력 테이블 생성(TB_PRODETAIL)
--어떤 상품이 어떤 날짜에 몇개사 입출고 되는지 기록
...
--210번 상품이 오늘 날짜로 7개 입고됨

INSERT INTO TB_PRODETAIL
VALUES(SEQ_DECODE.NEXTVAL, 210, SYSDATE, 7, 'IN');

--205번 상품이 오늘 날짜로 5개 출고됨
