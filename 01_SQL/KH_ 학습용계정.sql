...
SET DEFINE OFF;
Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('200','선동일','900101-1985634','sun_di@kh.co.kr','01099546325','D9','J1',8000000,0.3,null,to_date('90/02/06','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('201','송종기','901120-1548654','song_jk@kh.co.kr','01045686656','D9','J2',6000000,null,'200',to_date('01/09/01','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('202','노옹철','861015-1356452','no_hc@kh.co.kr','01066656263','D9','J2',3700000,null,'201',to_date('01/01/01','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('203','송은희','631010-2653546','song_eh@kh.co.kr','01077607879','D6','J4',2800000,null,'204',to_date('96/05/03','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('204','유재식','660508-1342154','yoo_js@kh.co.kr','01099999129','D6','J3',3400000,0.2,'200',to_date('00/12/29','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('205','정중하','770102-1357951','jung_jh@kh.co.kr','01036654875','D6','J3',3900000,null,'204',to_date('99/09/09','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('206','박나라','630709-2054321','pack_nr@kh.co.kr','01096935222','D5','J7',1800000,null,'207',to_date('08/04/02','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('207','하이유','690402-2040612','ha_iy@kh.co.kr','01036654488','D5','J5',2200000,0.1,'200',to_date('94/07/07','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('208','김해술','870927-1313564','kim_hs@kh.co.kr','01078634444','D5','J5',2500000,null,'207',to_date('04/04/30','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('209','심봉선','750206-1325546','sim_bs@kh.co.kr','0113654485','D5','J3',3500000,0.15,'207',to_date('11/11/11','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('210','윤은해','650505-2356985','youn_eh@kh.co.kr','0179964233','D5','J7',2000000,null,'207',to_date('01/02/03','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('211','전형돈','830807-1121321','jun_hd@kh.co.kr','01044432222','D8','J6',2000000,null,'200',to_date('12/12/12','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('212','장쯔위','780923-2234542','jang_zw@kh.co.kr','01066682224','D8','J6',2550000,0.25,'211',to_date('15/06/17','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('213','하동운','621111-1785463','ha_dh@kh.co.kr','01158456632',null,'J6',2320000,0.1,null,to_date('99/12/31','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('214','방명수','940111-1313513','bang_ms@kh.co.kr','01074127545','D1','J7',1380000,null,'200',to_date('10/04/04','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('215','대북혼','881130-1050911','dae_bh@kh.co.kr','01088808584','D5','J5',3760000,null,null,to_date('17/06/19','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('216','차태연','770808-1364897','cha_ty@kh.co.kr','01064643212','D1','J6',2780000,0.2,'214',to_date('13/03/01','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('217','전지연','770808-2665412','jun_jy@kh.co.kr','01033624442','D1','J6',3660000,0.3,'214',to_date('07/03/20','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('218','이오리','870427-2232123','loo_or@kh.co.kr','01022306545',null,'J7',2890000,null,null,to_date('16/11/28','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('219','임시환','660712-1212123','im_sw@kh.co.kr',null,'D2','J4',1550000,null,null,to_date('99/09/09','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('220','이중석','770823-1113111','lee_js@kh.co.kr',null,'D2','J4',2490000,null,null,to_date('14/09/18','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('221','유하진','800808-1123341','yoo_hj@kh.co.kr',null,'D2','J4',2480000,null,null,to_date('94/01/20','RR/MM/DD'),null,'N');

Insert into C##KH.EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,EMAIL,PHONE,DEPT_CODE,JOB_CODE,SALARY,BONUS,MANAGER_ID,HIRE_DATE,ENT_DATE,ENT_YN) 
values ('222','이태림','760918-2854697','lee_tr@kh.co.kr','01033000002','D8','J6',2436240,0.35,'100',to_date('97/09/12','RR/MM/DD'),to_date('17/09/12','RR/MM/DD'),'Y');
--------------------------------------------------------
