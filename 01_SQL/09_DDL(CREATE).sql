/*
DDL(DATE DEFTNTION LANGUAGE) : 데이터 정의어
데이터베이스에서 사용하는 SQL명령어 중 데이터를 저장할 객체의 구조를 정의하거나 연결하는 역할을 한다.
즉, 실제 데이터값이 아닌 규칙 자체를 정의하는 언어.

오라클에서 객체(구조) : 테이블,뷰,시퀸스,인덱스,패키지,트리거,프로시저,사용자 등..
...
CREATE TABLE MEMBER(
  MEM_NO NUMBER,
  MEM_ID VARCHAR2(30), --USER01 TEST121234
  MEM_PWD VARCHAR2(30),
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1111-2222','AA@NAVER.COM,', '25/07/30');
SELECT * FROM MEMBER;
...
종류 : NOT NULL, UNIQUE, CHEAK, PRIMARY KEY, FOREIGN KEY... 
*/
...
CREATE TABLE MEMBER(
  ...
  MEM_ID VARCHAR2(30) NOT NULL, --USER01 TEST121234
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홀길순', NULL,NULL,NULL, NULL);
...
CREATE TABLE MEMBER(
  MEM_NO NUMBER NOT NULL,
  MEM_ID VARCHAR2(30) NOT NULL UNIQUE, --USER01 TEST121234
  MEM_PWD VARCHAR2(30) NOT NULL,
  MEM_NAME VARCHAR2(21) NOT NULL,
  GENDER CHAR(3),
  PHONE VARCHAR2(13),
...
CREATE TABLE MEMBER(
  ...
  MEM_ID VARCHAR2(30) CONSTRAINT MEMID_NT  NOT NULL CONSTRAINT MEMID_UQ UNIQUE, --USER01 TEST121234
...
INSERT INTO MEMBER
VALUES(2, 'USER02', 'PASS02', '홀길순', '왜',NULL,NULL, NULL);
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길동', NULL, '010-1111-2222','AA@NAVER.COM,', '25/07/30');
SELECT * FROM MEMBER;

INSERT INTO MEMBER
VALUES(1, 'USER02', 'PASS02', '홍길동', '여', '010-1111-2222','BB@NAVER.COM,', '25/07/30');
...
INSERT INTO MEMBER
VALUES(1, 'USER02', 'PASS02', '홍길동', NULL, '010-1111-2222','AA@NAVER.COM,', '25/07/30');
--기본키에 중복된 값을 담으려고할 때 UNIQUE제약조건 위반

INSERT INTO MEMBER
VALUES(NULL, 'USER02', 'PASS02', '홍길동', NULL, '010-1111-2222','AA@NAVER.COM,', '25/07/30');
--기본키에 NULL 값을 담으려고할 때 NOT NULL제약조건 위반

INSERT INTO MEMBER
VALUES(2, 'USER02', 'PASS03', '홍길동', NULL, '010-1111-2222','BB@NAVER.COM,', '25/07/30');

INSERT INTO MEMBER
VALUES(3, 'USER03', 'PASS04', '홍길동', NULL, '010-1111-2222','CC@NAVER.COM,', '25/07/30');

INSERT INTO MEMBER
VALUES(4, 'USER04', 'PASS05', '홍길동', NULL, '010-1111-2222','DD@NAVER.COM,', '25/07/30');
...
--> 다른 테이블을 참조한다고 표현
--> 대부분의 경우 FOREIGN KEY를 통해서 테이블간의 관계가 활성화된다.
...
--부모테이블로부터 무조건 삭제가 안되는 "삭제제한"옵션이 기본적으로 설정되어있음.
...
-ON DELETE SET NULL : 부모데이터 삭제시 해당 데이터를 사용하고 잇는 자식데이터의 값을 NULL로 변경.
...
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = 40;
--MEM_GRADE PJ 40데이터가 삭제되면 SET NULL옵션에 따라 GRADE_CODE 40인 데이터를 참조하던 자식 데이터들은 전부 NULL을 가짐
...
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = 10;
--MEM_GRADE PK 10데이터가 삭제되면 CASCADE옵션에 따라 자식 데이터 중
...
INSERT INTO MEM VALUES(2,'USER02',20,NULL,NULL);
INSERT INTO MEM VALUES(3,'USER03',20,DEFAULT,DEFAULT);

--INSERT INTO 테이블명(컬럼1,컬럼2)VALUES(값1,값2);
INSERT INTO MEM(MEM_NO,MEM_ID)
VALUES(5,'USER05');
-->선택되지 않은 컬럼에는 기본적으로 NULL이 적용됨
-->단 해당 컬럼에 디폴트값이 부여되어 있다면 NULL이아닌 DEFAULT값이 적용됨.
...
-FOREIGN KEY : ALTER TABLE 테이블명 ADD [CONSTRAINT 제약조건명] FOREIGN KEY(컬럼명) REPERENCES 참조할 테이블명(컬럼명);
-UNIQUE : ALTER TABLE 테이블명 ADD [CONSTRAINT 제약조건명] UNIQUE(컬럼명);
-CHEAK : ALTER TABLE 테이블명 ADD [CONSTRAINT 제약조건명] CHEAK(컬럼에대한 조건식)
