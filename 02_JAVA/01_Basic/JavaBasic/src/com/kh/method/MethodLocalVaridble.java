...
public class MethodLocalVaridble {
	/*
	 * 지역변수
	 * - 블록({})내부에서 선언된 변수
	...
	public static void main(String[] args) {
		...
		if(name.equals("철수")) {
//			String name = "지월"; 포함되는 관계는 같은 지역이므로 동일한 이름을 사용할 수 없음.
		}
		
		//Call By Value(값의 의한 호출)->자바는 무조건 이방식으로 호출
		//메모리에 담긴 값 자체를 전달
		//기본형 -> 값(데이터)자체가 복사됨
		//참조형 -> 참조값(주소)이 복사됨
	...
	public static void changeRe(int[] array) {
