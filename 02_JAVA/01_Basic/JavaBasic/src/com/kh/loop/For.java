...
public class For {
	/*
	 * [반복문]
	 * 특정 코드를 여러번 반복해서 실행하고자 할 때 사용하는 제어문
	 * 
...
//		for(int i=0; i<5; i++) {
//			System.out.print("안녕하세요".charAt(i));
//		}
//        
//		for(int i=0;i<=17;i++) {
...
//		}
		...
		*/ 
	//정수n을 입력받아 1부터 n까지 1씩 증가시키면서 출력해라.
	//정수입력 : n
	//1 2 3 4.....n
	...
	*/
	 ...
	 */
	/*
     System.out.print("아메리카노를 몇잔 구매하시겠습니까? : ");
     int count = sc.nextInt();
     int sum = 0;
     for(int i=0;i<count;i++) {
    	 sum+=1100;
     }
     System.out.println("결제하실 금액"+sum+"입니다.");
...
//	System.out.println(Math.random());
	...
	//1~n까지의 합 : xxxx
//	int sum1 = 0;
//	for(int i =(int)(Math.random()*10)+1; i<=(int)(Math.random()*10)+1; i++) {
//		sum1+=i;
//	}
//	System.out.println(sum1);
	...
	/*
	String str = sc.next();
	System.out.print("문자열 길이 : "+ str.length());
