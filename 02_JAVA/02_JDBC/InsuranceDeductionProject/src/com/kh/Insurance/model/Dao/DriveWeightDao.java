...
public class DriveWeightDao {
	...
	public int insertDriveWeight(DriveWeight d ,Connection conn) {
		...
		try {
			...
			pstmt.setInt(1, d.getCompanyId());
			pstmt.setInt(2, d.getCarId());
			pstmt.setInt(3, d.getExperienceMin());
			pstmt.setInt(4, d.getExperienceMax());
			pstmt.setDouble(5, d.getDwWeightScore());
