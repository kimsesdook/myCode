...
public class AccidentWeightDao {
	...
	public int insertAccidentWeight(AccidentWeight w ,Connection conn) {
		...
		try {
			...
			pstmt.setInt(1, w.getCompanyId());
			pstmt.setInt(2, w.getCarId());
			pstmt.setInt(3, w.getAccidentMin());
			pstmt.setInt(4, w.getAccidentMax());
			pstmt.setDouble(5, w.getAwWeightScore());
